...
const ProjectModal = ({ project, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-5 flex items-center justify-center px-4" style={{
            ...
            <motion.div
                ...
                className="dark:bg-[#1f1f1f] bg-[#fff0fb] dark:text-white p-6 rounded-2xl w-full max-w-3xl relative shadow-lg"
                style={{
                    boxShadow: `0 0 60px 5px rgba(255, 115, 0, 0.4), 0 0 150px 30px rgba(148, 0, 211, 0.2)`
                }}
            >
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                        onClick={onClose}
                        className="dark:text-white text-2xl hover:text-pink-500 cursor-pointer"
                    >
                        <IoClose />
                    </button>
                </div>
                ...
                {/* Description */}
                <p className="dark:text-gray-300 mb-4 text-[12px]">
                    {details}
                </p>
